...
public class TestTileEntity {
    ...
    public void setUp() throws Exception {
        // this.t =
        // GenericTileEntity.builder("Test").add(string).add(integer).build();
        // this.t2 =
        // GenericTileEntity.builder("Test").add(stringInteger).add(string).add(integer).build();
    }

    @Test
    public void testTileEntity() {
        // assertEquals(this.t, new
        // GenericTileEntity(NBT.Compound("Test").add(string).add(integer)));
    }

    @SuppressWarnings("static-method")
    @Test
    public void testBuilder() {
        // assertEquals(NBT.Compound("Test"),
        // GenericTileEntity.builder("Test"));
    }
